...
@objc public  class DATB : NSObject {
    static var appDelegate = UIApplication.shared.delegate!
       private static var momagicId = Int()
       ...
       private static var momagicAppId : String!
    ...
    @objc public static func initialisation(momagic_app_id : String, application : UIApplication,MoMagicInitSettings : Dictionary<String,Any>)
    {
        ...
        momagicAppId = momagic_app_id
        keySettingDetails = MoMagicInitSettings
        RestAPI.getRequest(uuid: momagicAppId) { (output) in
                   ...
                   guard let jsonString = finalOutPut.fromBase64() else {
                       if defaults.value(forKey: "initialisationBase64") == nil{
                           ...
                           RestAPI.sendExceptionToServer(exceptionName: ".dat base64 == \(output)", className: "DATB", methodName: "initialisation", pid: 0, token: "0", rid: "0", cid: "0")
                       }
                       return
                   }
                   if let data = jsonString.data(using: .utf8) {
                       ...
                       if let dictionary = json as? [String: Any] {
                           ...
                           if defaults.value(forKey: "initialisationId") == nil{
                               ...
                               RestAPI.sendExceptionToServer(exceptionName: ".dat response error \(json ?? "")", className: "DATB", methodName: "initialisation", pid: 0, token: "0", rid: "0", cid: "0")
                           }
                       }
                   }
               }
               if(!keySettingDetails.isEmpty)
               {
                   if let webViewSetting = keySettingDetails[AppConstant.iZ_KEY_WEBVIEW] {
                       ...
                       if defaults.value(forKey: "initialisationWeb") == nil{
                           ...
                           RestAPI.sendExceptionToServer(exceptionName: AppConstant.iZ_KEY_WEBVIEW_ERROR, className: "DATB", methodName: "initialisation", pid: momagicId, token: "0", rid: "0", cid: "0")
                       }
                   }
                   ...
                   else
                   {
                       ...
                       if defaults.value(forKey: "initialisationPro") == nil{
                           ...
                           RestAPI.sendExceptionToServer(exceptionName: AppConstant.iZ_KEY_PROVISIONAL_NOT_FOUND, className: "DATB", methodName: "initialisation", pid: momagicId, token: "0", rid: "0", cid: "0")
                       }
                   }
                   if let autoPromptEnabled = keySettingDetails[AppConstant.iZ_KEY_AUTO_PROMPT] as? Bool{
                       ...
                       if defaults.value(forKey: "initialisation") == nil{
                           ...
                           RestAPI.sendExceptionToServer(exceptionName: AppConstant.iZ_KEY_AUTO_PROMPT_NOT_FOUND, className: AppConstant.IZ_TAG, methodName: AppConstant.iZ_KEY_INITIALISE, pid: momagicId, token: "\(momagic_app_id ?? "")", rid: "0", cid: "0")
                       }
                   }
      ...
      @objc public static func getToken(deviceToken : Data)
      {
          ...
          if UserDefaults.getRegistered() && (token == storedToken)
          {
              ...
              if let userDefaults = UserDefaults(suiteName: Utils.getBundleName()) {
                  ...
                  userDefaults.set(momagicId, forKey: AppConstant.REGISTERED_ID)
              ...
              if(RestAPI.SDKVERSION != sharedUserDefault?.string(forKey: AppConstant.iZ_SDK_VERSION)) || (RestAPI.getAppVersion() != sharedUserDefault?.string(forKey: AppConstant.iZ_APP_VERSION))
              {
                  ...
                  RestAPI.registerToken(token: token, momagicId: momagicId)
              }
          }
          else
          {
              DispatchQueue.main.asyncAfter(deadline: .now() + 3){
                  if(momagicId != 0 && token != "")
                  {
                      RestAPI.registerToken(token: token, momagicId: momagicId)
                      ...
                      if let userDefaults = UserDefaults(suiteName: Utils.getBundleName()) {
                          userDefaults.set(token, forKey: AppConstant.IZ_GRPS_TKN)
                          userDefaults.set(momagicId, forKey: AppConstant.iZ_PID)
                          userDefaults.synchronize()
                      }
                  }
                  else
                  {
                      ...
                      if defaults.value(forKey: "getTokennn") == nil{
                          ...
                          RestAPI.sendExceptionToServer(exceptionName: AppConstant.iZ_KEY_REGISTERED_ID_ERROR, className: AppConstant.IZ_TAG, methodName: "GetToken", pid: momagicId , token: token, rid: "", cid: "")
                      }
                  }
              }
          }
    ...
    // getAdvertisement ID
       ...
       @objc public static func getAdvertisementID(adid: NSString) {
           ...
           if !(sharedUserDefault?.bool(forKey: AppConstant.iZ_KEY_ADVERTISEMENT_ID) ?? true) {
               RestAPI.registerToken(token: token, momagicID: userID, adid: adid)
           }
       }
    //All Notification Data
       @objc public static func getNotificationFeed(isPagination: Bool,completion: @escaping (String?, Error?) -> Void){
           
           if let userID = sharedUserDefault?.string(forKey: SharedUserDefault.Key.registerID), let token = Utils.getUserDeviceToken(){
               ...
               completion("MoMagic is not initialized properly, Please verify again.", nil)
           }
       }
                   ...
                   if let data = data {
                       do {
                           ...
                           if defaults.value(forKey: "fallBackAdsApi") == nil{
                               ...
                               RestAPI.sendExceptionToServer(exceptionName: "Fallback ad Api error\(error.localizedDescription)", className: "DATB", methodName: "fallBackAdsApi", pid: self.iZPid, token: self.iZTkn, rid: notiRid , cid: "0")
                           }
                       }
                   }
                   ...
                   if aps.value(forKey: AppConstant.iZ_ANKEY) != nil {
                           ...
                           if notificationData?.ankey != nil {
                               if(notificationData?.global?.inApp != nil)
                               {
                                   ...
                                   if(bundleName != "")
                                   {
                                       ...
                                       if let userDefaults = UserDefaults(suiteName: groupName) {
                                           ...
                                           self.iZTkn = userDefaults.string(forKey: AppConstant.IZ_GRPS_TKN) ?? ""
                                           self.iZPid = userDefaults.integer(forKey: AppConstant.iZ_PID)
                                       ...
                                       else
                                       {
                                           ...
                                           if defaults.value(forKey: "didreceiveGroup") == nil{
                                               ...
                                               RestAPI.sendExceptionToServer(exceptionName: AppConstant.iZ_APP_GROUP_ERROR_, className: "DATB", methodName: "didReceive", pid: self.iZPid, token: self.iZTkn, rid: notificationData?.global?.rid ?? "0", cid: notificationData?.global?.id ?? "0")
                                           }
                                       }
                                   }
                                   //Relevance Score
                               ...
                               else
                               {
                                   ...
                                   if defaults.value(forKey: "didreceiveOther") == nil{
                                       ...
                                       RestAPI.sendExceptionToServer(exceptionName: "\(AppConstant.iZ_KEY_OTHER_PAYLOD) \(userInfo)", className: "DATB", methodName: "didReceive", pid: self.iZPid, token: self.iZTkn, rid: "", cid: "")
                                   }
                               }
                           }
                       }
                       ...
                       if(bundleName != "")
                       {
                           ...
                           else
                           {
                               ...
                               if defaults.value(forKey: "didreceiveGroup") == nil{
                                   defaults.setValue("true", forKey: "didreceiveGroup")
                                   RestAPI.sendExceptionToServer(exceptionName: AppConstant.iZ_APP_GROUP_ERROR_, className: "DATB", methodName: "didReceive", pid: self.iZPid, token: self.iZTkn, rid: notificationData?.rid ?? "", cid: notificationData?.id ?? "")
                               }
                           }
                       }
                       //Relevance Score
                                   ...
                                   DispatchQueue.main.async {
                                       ...
                                       if let url = URL(string: izUrlString ?? "") {
                                           ...
                                           if defaults.value(forKey: "payLoadDataChangetp4") == nil{
                                               ...
                                               RestAPI.sendExceptionToServer(exceptionName: "FetchUrl error for tp 4\(izUrlString)", className: "DATB", methodName: "fallBackAdsApi", pid: self.iZPid, token: self.iZTkn, rid: gt.value(forKey: "r") as! String , cid: "0")
                                           }
                                       }
                                   }
                               }
                                       ...
                                       DispatchQueue.main.async {
                                           ...
                                           if let url = URL(string: izUrlString) {
                                                   ...
                                                   if finalArray.count == (anKey as AnyObject).count{
                                                       ...
                                                       if servedArray.count != 0{
                                                           for data in servedArray{
                                                               ...
                                                               let finalcpc = Double(fCPCC!)
                                                               let fff =  String(finalcpc!)
                                               ...
                                               if defaults.value(forKey: "payLoadDataChangetp5") == nil{
                                                   ...
                                                   RestAPI.sendExceptionToServer(exceptionName: "fetchUrl error in tp 5 = \(izUrlString)", className: "DATB", methodName: "fallBackAdsApi", pid: self.iZPid, token: self.iZTkn, rid: gt.value(forKey: "r") as! String , cid: "0")
                                               }
                                           }
                                       }
                                       myGroup.leave()
                           ...
                           if let jsonDictionary = json as? [String:Any] {
                               if let value = jsonDictionary["msgCode"] as? String {
                                   ...
                                   if let jsonDictionary = json as? [String:Any] {
                                       if cpmValue != ""{
                                           let cpc =  "\(getParseValue(jsonData: jsonDictionary, sourceString: cpcFinalValue ))"
                                           finalCPCValue = String(Double(cpc) ?? 0.0/(10  * Double(ctrValue)!))
                                       }else{
                                           finalCPCValue = "\(getParseValue(jsonData: jsonDictionary, sourceString: cpcFinalValue ))"
                                       }
                                       let t = Int(Date().timeIntervalSince(startDate) * 1000)
          ...
          if notificationData.ankey != nil {
              ...
              if let url = URL(string: izUrlString) {
                  ...
                  if defaults.value(forKey: "commonfetchUrl") == nil{
                      ...
                      RestAPI.sendExceptionToServer(exceptionName: "Mediation fetch url is not in correct format\(izUrlString)", className: "DATB", methodName: "commonFetchUrl", pid: self.iZPid, token: self.iZTkn, rid: notificationData.global?.rid ?? "" , cid: notificationData.global?.id ?? "")
                  }
              }
          }else{
              ...
              if let url = URL(string: izUrlString) {
                  ...
                  if defaults.value(forKey: "commonfetchUrl") == nil{
                      defaults.setValue("true", forKey: "commonfetchUrl")
                      RestAPI.sendExceptionToServer(exceptionName: "Fetcher url is not in correct format\(izUrlString)", className: "DATB", methodName: "commonfetchUrl", pid: self.iZPid, token: self.iZTkn, rid: notificationData.rid ?? "", cid: notificationData.id ?? "")
       ...
       @objc private static func convertToDictionary(text: String) -> [String: Any]? {
           if let data = text.data(using: .utf8) {
               do {
                   ...
                   let userID = Utils.getUserPID() ?? 0
                   let token = Utils.getUserDeviceToken() ?? "No token here"
                       ...
                       if let anKey = aps.value(forKey: AppConstant.iZ_ANKEY) {
                                   ...
                                   else
                                   {
                                       ...
                                       else
                                       {
                                           ...
                                           if defaults.value(forKey: "handleForeGroundNotification") == nil{
                                               ...
                                               RestAPI.sendExceptionToServer(exceptionName: "DATB Payload is not exits\(userInfo)", className:AppConstant.iZ_REST_API_CLASS_NAME, methodName: "handleForeGroundNotification", pid: Utils.getUserPID() ?? 0, token: Utils.getUserDeviceToken() ?? "", rid: "",cid : "")
                                           }
                                       }
                                   }
                               }
                           ...
                           else
                           {
                               ...
                               else
                               {
                                   ...
                                   if defaults.value(forKey: "handleForeGroundNotification") == nil{
                                       defaults.setValue("true", forKey: "handleForeGroundNotification")
                                       RestAPI.sendExceptionToServer(exceptionName: "DATB Payload is not exits\(userInfo)", className:"DATB", methodName: "handleForeGroundNotification", pid: Utils.getUserPID() ?? 0, token: Utils.getUserDeviceToken() ?? "", rid: "",cid : "")
                                   }
                               }
                           }
                       }
                   ...
                   if let data = data {
                       do {
                           ...
                           if defaults.value(forKey: "FallbackClickHandler") == nil{
                               ...
                               RestAPI.sendExceptionToServer(exceptionName: "Error in fallback click API= \(izUrlString)", className: "DATB", methodName: "FallbackClickHandler", pid: self.iZPid, token: self.iZTkn, rid: "",cid : "")
                           }
                       }
                   }
               }.resume()
                       ...
                       if notificationData?.ankey != nil{
                           ...
                           if adlandingURL != ""
                           {
                               ...
                               if defaults.value(forKey: "NotificationHandlerrr") == nil{
                                   ...
                                   RestAPI.sendExceptionToServer(exceptionName: "Mediation LandingUrl is blank", className: "DATB", methodName: "notificationHandler", pid: userID, token: token, rid: notiRid ?? "", cid: notificationData?.global?.id ?? "")
                               }
                           }
                       }
                   }else{
                                   ...
                                   if let data = data {
                                       do {
                                           ...
                                           if defaults.value(forKey: "NotificationHandlerr") == nil{
                                               ...
                                               RestAPI.sendExceptionToServer(exceptionName: error.localizedDescription, className: "DATB", methodName: "notificationHandler", pid: userID, token: token, rid: rid, cid: notificationData?.rid ?? "")
                                           }
                                       }
                                   }
                               }.resume()
       ...
       @objc static func impressionTrack(notificationData : Payload, userInfo : [AnyHashable : Any])
       {
           if(notificationData.cfg != nil || notificationData.global?.cfg != nil)
           {
               if(notificationData.cfg != nil)
               {
                   ...
                   if(firstDigit == 1)
                   {
                       RestAPI.callImpression(notificationData: notificationData,userid: Utils.getUserPID() ?? 0,token: Utils.getUserDeviceToken() ?? "", userInfo: userInfo)
                   }
                       ...
                       if(ninthDigit == 1 && seventhDigit == 1)
                       {
                           if(formattedDate != sharedUserDefault?.string(forKey: AppConstant.IZ_LAST_VIEW))
                           {
                               ...
                               if convertBinaryToDecimal != 0{
                                   ...
                                   RestAPI.lastImpression(notificationData: notificationData,userid: Utils.getUserPID() ?? 0,token: Utils.getUserDeviceToken() ?? "",url: url, userInfo: userInfo)
                               }
                               else
                               {
                                   RestAPI.lastImpression(notificationData: notificationData,userid: Utils.getUserPID() ?? 0,token: Utils.getUserDeviceToken() ?? "",url: RestAPI.LASTNOTIFICATIONVIEWURL, userInfo: userInfo)
                               }
                           }
                       }
               ...
               }else
               {
                   ...
                   if defaults.value(forKey: "ImpressionTrackkk") == nil{
                       ...
                       RestAPI.sendExceptionToServer(exceptionName: "No CFG Key defined \(userInfo)", className: "DATB", methodName: "ImpressionTrack", pid: self.iZPid, token: self.iZTkn, rid: ((notificationData.rid) ?? (notificationData.global?.rid)) ?? "", cid: ((notificationData.id) ?? (notificationData.global?.id)) ?? "")
                   }
               }
           }
       }
   ...
   @objc static func clickTrack(notificationData : Payload,actionType : String, userInfo: [AnyHashable: Any], globalLn : String,title : String)
       {
           ...
           guard notificationData.cfg != nil || notificationData.global?.cfg != nil else {
               ...
               if defaults.value(forKey: "ClickTrackkk1") == nil{
                   ...
                   RestAPI.sendExceptionToServer(exceptionName: "Both cfg values are nil.", className: "DATB", methodName: "ClickTrack", pid: self.iZPid, token: self.iZTkn, rid: ((notificationData.rid) ?? (notificationData.global?.rid)) ?? "", cid: ((notificationData.id) ?? (notificationData.global?.id)) ?? "")
               }
               return
           }
           if(notificationData.cfg != nil){
                   ...
                   if(tenthDigit == 1 && eighthDigit == 1){
                       ...
                       if(formattedDate != sharedUserDefault?.string(forKey: AppConstant.IZ_LAST_CLICK))
                       {
                           ...
                           if convertBinaryToDecimal != 0{
                               ...
                               RestAPI.lastClick(notificationData: notificationData, userid: Utils.getUserPID() ?? 0,token: Utils.getUserDeviceToken() ?? "",url: url, userInfo: userInfo )
                           }
                           else
                           {
                               RestAPI.lastClick(notificationData: notificationData, userid: Utils.getUserPID() ?? 0,token: Utils.getUserDeviceToken() ?? "",url: RestAPI.LASTNOTIFICATIONCLICKURL, userInfo: userInfo )
                           }
                       }
                   }
           ...
           else
           {
               ...
               if defaults.value(forKey: "ClickTrackkk") == nil{
                   ...
                   RestAPI.sendExceptionToServer(exceptionName: "No CFG Key defined \(userInfo)", className: "DATB", methodName: "ClickTrack", pid: self.iZPid, token: self.iZTkn, rid: ((notificationData.rid) ?? (notificationData.global?.rid)) ?? "", cid: ((notificationData.id) ?? (notificationData.global?.id)) ?? "")
               }
           }
       }
           ...
           if let token = Utils.getUserDeviceToken(),
              let userID = Utils.getUserPID(){
               ...
               if defaults.value(forKey: "setSubscription") == nil{
                   ...
                   RestAPI.sendExceptionToServer(exceptionName: "token or AppId not found", className: "DATB", methodName: "setSubscription", pid: 0, token: "0", rid: "0", cid: "0")
               }
           }
       }
           ...
           if let theJSONData = try? JSONSerialization.data(withJSONObject: returnData, options: .fragmentsAllowed),
              let validateData = String(data: theJSONData, encoding: .utf8) {
               ...
               if let token = Utils.getUserDeviceToken(), !token.isEmpty {
                   RestAPI.callEvents(eventName: Utils.eventValidate(eventName: eventName), data: validateData as NSString, userid: Utils.getUserPID() ?? 0, token: token)
               } else {
               ...
               if (!returnData.isEmpty)
               {
                   ...
                   if let validationData = NSString(data: theJSONData,encoding: String.Encoding.utf8.rawValue),
                      let token = Utils.getUserDeviceToken(){
                       if (!token.isEmpty)
                       {
                           RestAPI.callUserProperties(data: validationData as NSString, userid: Utils.getUserPID() ?? 0, token: token)
                       }
                       else
                       {
