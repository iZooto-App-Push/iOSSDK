...
#ifndef MOMAGICIOSPROJECT_SWIFT_H
#define MOMAGICIOSPROJECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MoMagiciOSProject",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17MoMagiciOSProject11AppDelegate")
@interface AppDelegate : UIResponder <LandingURLDelegate, NotificationOpenDelegate, NotificationReceiveDelegate, UIApplicationDelegate, UNUserNotificationCenterDelegate>
...
SWIFT_CLASS("_TtC17MoMagiciOSProject13SceneDelegate")
...
SWIFT_CLASS("_TtC17MoMagiciOSProject14ViewController")
